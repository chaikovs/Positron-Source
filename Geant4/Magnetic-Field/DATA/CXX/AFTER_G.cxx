void AFTER_G() {
    ...
    ifstream in1, in10;
    in1.open("../AFTER_TARGET/G_E.dat");
    in10.open("../AFTER_MAGNET/G_E.dat");
    assert(in1.is_open());
    assert(in10.is_open());
    Double_t par1;
    Double_t par10;
    ...
    c1->SetLogy(1);
    TH1F *h1 = new TH1F("AFTER_TARGET_E","Energy spectrum of the photons",90,0,6000);
    h1->GetXaxis()->SetTitle("Energy, MeV");
    h1->GetYaxis()->SetTitle("Number of the photons");
    ...
    in1.open("../AFTER_TARGET/G_P.dat");
    in10.open("../AFTER_MAGNET/G_P.dat");
    assert(in1.is_open());
    assert(in10.is_open());
    
    c1->SetLogy(1);
    TH1F *h2 = new TH1F("AFTER_TARGET_P","Angular distribution of the photons (Phi)",60,-180,180);
    h2->GetXaxis()->SetTitle("Phi, deg");
    h2->GetYaxis()->SetTitle("Number of the photons");
    h2->GetYaxis()->SetRangeUser(50000, 500000);
    ...
    in1.open("../AFTER_TARGET/G_T.dat");
    in10.open("../AFTER_MAGNET/G_T.dat");
    assert(in1.is_open());
    assert(in10.is_open());
    
    c1->SetLogy(1);
    TH1F *h3 = new TH1F("AFTER_TARGET_T","Angular distribution of the photons (Theta)",60,0,90);
    h3->GetXaxis()->SetTitle("Theta, deg");
    h3->GetYaxis()->SetTitle("Number of the photons");
