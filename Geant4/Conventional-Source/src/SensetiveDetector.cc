...
G4bool SensitiveDetector::ProcessHits(G4Step *step, G4TouchableHistory*)
{
    ...
    std::ofstream filePositron("AFTERpositron.dat", std::ios::app);
    if(nameOfParticle == "e+")
    {
    ...
    std::ofstream fileElectron("AFTERelectron.dat", std::ios::app);
    if(nameOfParticle == "e-")
    {
    ...
    std::ofstream fileGamma("AFTERgamma.dat", std::ios::app);
...
{
    std::ofstream fileNum("AFTERnumber.dat");
